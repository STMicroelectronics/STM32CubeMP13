/**
  ******************************************************************************
  * @file    stm32mp13xx_disco_sd.c
  * @author  MCD Application Team
  * @brief   This file includes the uSD card driver mounted on STM32MP135F-DK
  *          boards.
  @verbatim
  How To use this driver:
  -----------------------
   - This driver is used to drive the micro SD external cards mounted on STM32MP135F-DK
     board.
...
/** @defgroup STM32MP13XX_DISCO_SD SD
  * @{
  */


/** @defgroup STM32MP13XX_DISCO_SD_Private_TypesDefinitions Private TypesDefinitions
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_SD_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_SD_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_SD_Private_Functions_Prototypes Private Functions Prototypes
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_SD_Exported_Functions Exported Functions
  * @{
  */
...
/** @defgroup STM32MP13XX_DISCO_SD_Private_Functions Private Functions
  * @{
  */
#if (USE_HAL_SD_REGISTER_CALLBACKS == 1)
/**
