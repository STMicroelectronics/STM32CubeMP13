/**
  ...
  *          Screen on STM32MP13xx-DISCO board.
  @verbatim
   1. How To use this driver:
   --------------------------
      - This driver is used to drive the touch screen module of the STM32MP13xx-DISCO
...
/** @addtogroup STM32MP13xx-DISCO
  * @{
  */

/** @defgroup STM32MP13xx-DISCO_TS TS
  * @{
  */

/** @defgroup STM32MP13xx-DISCO_TS_Private_Types_Definitions Private Types Definitions
  * @{
  */
...
/** @defgroup STM32MP13xx-DISCO_TS_Private_Defines Private Types Defines
  * @{
  */
/**
  * @}
...
/** @defgroup STM32MP13xx-DISCO_TS_Private_Macros Private Macros
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32MP13xx-DISCO_TS_Private_Function_Prototypes Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32MP13xx-DISCO_TS_Privates_Variables Privates Variables
  * @{
  */
...
/** @defgroup STM32MP13xx-DISCO_TS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32MP13xx-DISCO_TS_Exported_Functions Exported Functions
  * @{
  */
...
int32_t BSP_TS_Init(uint32_t Instance, TS_Init_t *TS_Init)
{
  ...
  if ((Instance >= TS_INSTANCES_NBR) || \
      (TS_Init->Width == 0U) || (TS_Init->Width > TS_MAX_WIDTH) || \
  ...
  else
  {
    ...
    switch (tmp)
    {
      case GT911_GEST_ID_NO_GESTURE :
        *GestureId = GT911_GEST_ID_NO_GESTURE;
        break;
      case GT911_GEST_ID_SWIPE_UP :
        *GestureId = GT911_GEST_ID_SWIPE_UP;
        break;
      case GT911_GEST_ID_SWIPE_RIGHT :
        *GestureId = GT911_GEST_ID_SWIPE_RIGHT;
        break;
      case GT911_GEST_ID_SWIPE_DOWN :
        *GestureId = GT911_GEST_ID_SWIPE_DOWN;
        break;
      case GT911_GEST_ID_SWIPE_LEFT :
        *GestureId = GT911_GEST_ID_SWIPE_LEFT;
        break;
      case GT911_GEST_ID_DOUBLE_TAP :
        *GestureId = GT911_GEST_ID_DOUBLE_TAP;
        break;
      default :
        *GestureId = GT911_GEST_ID_NO_GESTURE;
        break;
...
/**
  * @}
  */
/** @defgroup STM32MP13xx-DISCO_TS_Private_Functions Private Functions
  * @{
  */
