...
2. It writes the data to all RTC Backup data registers, then check whether the
   data were correctly written. If yes, LED_GREEN toggles with a period of 1s,
   otherwise LED_RED turns ON.
3. When applying a low level on the Tamper (Tamper2) pin (PA.6) by pressing the Tamper push-button,
   ...
   If yes LED_GREEN toggles with a period of 100ms, otherwise LED_RED turns ON.
4. Debugger will go OFF after pressing the Tamper button (normal behavior).
...
@par Directory contents
  ...
  - RTC/RTC_Tamper/Inc/stm32mp13xx_hal_conf.h    HAL configuration file
  - RTC/RTC_Tamper/Inc/stm32mp13xx_it.h          Interrupt handlers header file
  - RTC/RTC_Tamper/Inc/main.h                    Header for main.c module
  - RTC/RTC_Tamper/Inc/stm32mp13xx_hal_conf.h    STM32MP13xx board configuration file
  - RTC/RTC_Tamper/Src/stm32mp13xx_it.c          Interrupt handlers
  - RTC/RTC_Tamper/Src/main.c                    Main program
  - RTC/RTC_Tamper/Src/stm32mp13xx_hal_msp.c     HAL MSP module
  - RTC/RTC_Tamper/Src/system_stm32mp13xx.c      STM32MP13xx system source file
