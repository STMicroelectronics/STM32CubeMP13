...
int main(void)
{
  ...
  /* Initialize the BUTTON_WAKEUP to generate external interrupts */
  ...
  /* Enable WakeUp Pin PWR_WAKEUP_PIN1_LOW connected to PWR_WAKEUP_PIN1 */
  HAL_PWR_EnableWakeUpPin(PWR_WAKEUP_PIN1_LOW);

  /* Prepare PMIC for the Standby mode */
  BSP_PMIC_PrepareStandby();
