...
static void MX_DMA_Init(void) 
{
  ...
  /* For secure access, DMA3 must be used, and it can be used only with DMAMUX2 */
  __HAL_RCC_DMA3_CLK_ENABLE();
  __HAL_RCC_DMAMUX2_CLK_ENABLE();

  /* DMA interrupt init */
  /* DMA3_Stream0_IRQn interrupt configuration */
  IRQ_SetPriority(DMA3_Stream0_IRQn, DEFAULT_IRQ_PRIO);
  IRQ_Enable(DMA3_Stream0_IRQn);
  /* DMA3_Stream1_IRQn interrupt configuration */
  IRQ_SetPriority(DMA3_Stream1_IRQn, DEFAULT_IRQ_PRIO);
  IRQ_Enable(DMA3_Stream1_IRQn);
#else
  /* DMA controller clock enable */
  /* For unsecure access, DMA1 or DMA2 can be used, and they can be used only with DMAMUX1. DMA2 is chosen here. */
  __HAL_RCC_DMA2_CLK_ENABLE();
  __HAL_RCC_DMAMUX1_CLK_ENABLE();

  /* DMA interrupt init */
  /* DMA2_Stream0_IRQn interrupt configuration */
  IRQ_SetPriority(DMA2_Stream0_IRQn, DEFAULT_IRQ_PRIO);
  IRQ_Enable(DMA2_Stream0_IRQn);
  /* DMA2_Stream1_IRQn interrupt configuration */
  IRQ_SetPriority(DMA2_Stream1_IRQn, DEFAULT_IRQ_PRIO);
...
{
  /* Turn LED_GREEN on: Transfer in transmission/reception process is complete */
