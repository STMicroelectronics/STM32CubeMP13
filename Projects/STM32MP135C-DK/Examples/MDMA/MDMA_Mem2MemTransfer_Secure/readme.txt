/**
  @page MDMA_Mem2MemTransfer_Secure MDMA Memory to Memory Transfer

  @verbatim
  ******************** (C) COPYRIGHT 2021 STMicroelectronics *******************
  * @file    MDMA/MDMA_Mem2MemTransfer_Secure/readme.txt
...
This example provides a description of how to use a MDMA (configured secure) to transfer a data buffer from SYSRAM to SRAM3 
through the HAL API.
...
In this example the MDMA is configured as Secure and Buffer Transfer mode is enabled.
...
@par Directory contents
  ...
  - MDMA/MDMA_Mem2MemTransfer_Secure/Src/system_stm32mp13xx.c    STM32MP13xx system clock configuration file
  - MDMA/MDMA_Mem2MemTransfer_Secure/Src/stm32mp13xx_it.c        Interrupt handlers
  - MDMA/MDMA_Mem2MemTransfer_Secure/Src/main.c                  Main program
  - MDMA/MDMA_Mem2MemTransfer_Secure/Inc/stm32mp13xx_hal_conf.h  HAL Configuration file
  - MDMA/MDMA_Mem2MemTransfer_Secure/Inc/stm32mp13xx_it.h        Interrupt handlers header file
  - MDMA/MDMA_Mem2MemTransfer_Secure/Inc/main.h                  Main program header file
