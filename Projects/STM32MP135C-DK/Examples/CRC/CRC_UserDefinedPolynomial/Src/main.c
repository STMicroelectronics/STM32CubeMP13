...
int main(void)
{
  ...
  uwCRCValue = HAL_CRC_Calculate(&hcrc1, (uint32_t *)&aDataBuffer, BUFFER_SIZE);
...
static void MX_CRC1_Init(void)
{
  ...
  hcrc1.Init.GeneratingPolynomial = 155;
  hcrc1.Init.CRCLength = CRC_POLYLENGTH_8B;
