...
a word data buffer from Flash memory to embedded SYSRAM configured non-secure
...
DMA1 is configured to transfer the contents of a 32-word data
...
The start of transfer is triggered by software. DMA1 memory-to-memory
transfer is enabled. Source and destination addresses incrementing is also enabled.
The transfer is started by setting the stream enable bit for DMA1.
...
@par Directory contents
  ...
  - DMA/DMA_FIFOMode/Src/system_stm32mp13xx.c    STM32MP13xx system clock configuration file
  - DMA/DMA_FIFOMode/Src/stm32mp13xx_it.c        Interrupt handlers
  - DMA/DMA_FIFOMode/Src/main.c                  Main program
  - DMA/DMA_FIFOMode/Inc/stm32mp13xx_hal_conf.h  HAL Configuration file
  - DMA/DMA_FIFOMode/Inc/stm32mp13xx_it.h        Interrupt handlers header file
