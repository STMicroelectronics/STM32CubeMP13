...
/* Private variables ---------------------------------------------------------*/
DMA_HandleTypeDef hdma_memtomem_dma3_stream0;
...
int main(void)
{
  ...
  HAL_DMA_RegisterCallback(&hdma_memtomem_dma3_stream0, HAL_DMA_XFER_CPLT_CB_ID, TransferComplete);
  HAL_DMA_RegisterCallback(&hdma_memtomem_dma3_stream0, HAL_DMA_XFER_ERROR_CB_ID, TransferError);

  /* Start the DMA transfer using the interrupt mode */
  /* Configure the source, destination and buffer size DMA fields and Start DMA Stream transfer */
  /* Enable All the DMA interrupts */
  if (HAL_DMA_Start_IT(&hdma_memtomem_dma3_stream0, (uint32_t)&aSRC_Const_Buffer, (uint32_t)&aDST_Buffer, BUFFER_SIZE) != HAL_OK)
  {
    /* Transfer Error */
    Error_Handler();
  }
...
static void MX_DMA_Init(void)
{
  ...
  /* Configure DMA request hdma_memtomem_dma3_stream0 on DMA3_Stream0 */
  hdma_memtomem_dma3_stream0.Instance = DMA3_Stream0;
  hdma_memtomem_dma3_stream0.Init.Request = DMA_REQUEST_MEM2MEM;
  hdma_memtomem_dma3_stream0.Init.Direction = DMA_MEMORY_TO_MEMORY;
  hdma_memtomem_dma3_stream0.Init.PeriphInc = DMA_PINC_ENABLE;
  hdma_memtomem_dma3_stream0.Init.MemInc = DMA_MINC_ENABLE;
  hdma_memtomem_dma3_stream0.Init.PeriphDataAlignment = DMA_PDATAALIGN_WORD;
  hdma_memtomem_dma3_stream0.Init.MemDataAlignment = DMA_MDATAALIGN_WORD;
  hdma_memtomem_dma3_stream0.Init.Mode = DMA_NORMAL;
  hdma_memtomem_dma3_stream0.Init.Priority = DMA_PRIORITY_LOW;
  hdma_memtomem_dma3_stream0.Init.FIFOMode = DMA_FIFOMODE_ENABLE;
  hdma_memtomem_dma3_stream0.Init.FIFOThreshold = DMA_FIFO_THRESHOLD_FULL;
  hdma_memtomem_dma3_stream0.Init.MemBurst = DMA_MBURST_INC4;
  hdma_memtomem_dma3_stream0.Init.PeriphBurst = DMA_PBURST_INC4;
  if (HAL_DMA_Init(&hdma_memtomem_dma3_stream0) != HAL_OK)
  {
    Error_Handler();
  }

  /* DMA interrupt init */
  /* DMA3_Stream0_IRQn interrupt configuration */
