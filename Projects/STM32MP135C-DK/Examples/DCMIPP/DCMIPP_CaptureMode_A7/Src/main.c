...
/**
  ******************************************************************************
  * @file    DCMIPP/DCMIPP_CaptureMode_A7/Src/main.c
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  memset((uint8_t *)Buffer, 0x7f, sizeof(Buffer));
...
static void Camera_Config(void)
{
  ...
  HAL_DCMIPP_PIPE_Start(&Hdcmipp, DCMIPP_PIPE0, (uint32_t)&Buffer, DCMIPP_MODE_CONTINUOUS);
}
