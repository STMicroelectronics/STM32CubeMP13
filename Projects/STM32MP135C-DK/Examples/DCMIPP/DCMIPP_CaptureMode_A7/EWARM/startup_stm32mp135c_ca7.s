 ...
 *----------------------------------------------------------------------------*/
   SECTION .text:CODE:NOROOT(4)
      ...
      DATA
IRQ_Vector_Table
      /* DCD             RESERVED_IRQHandler  ; */       /* Removed to correct interrupt mapping */
         DCD             SGI0_IRQHandler  ;
         DCD             SGI1_IRQHandler  ;
         DCD             SGI2_IRQHandler  ;
         DCD             SGI3_IRQHandler  ;
         ...
         DCD             NonSecurePhysicalTimer_IRQHandler  ;
         DCD             Legacy_nIRQ_IRQHandler  ;
         DCD             RESERVED_IRQHandler  ;       /* Added to correct interrupt mapping */
/*       DCD             TSC_IRQHandler  ; */        /* Removed to correct interrupt mapping */
...
goToSleep:
  ...
  /* Removed for IAR, not neeeded for ARM Mode */
