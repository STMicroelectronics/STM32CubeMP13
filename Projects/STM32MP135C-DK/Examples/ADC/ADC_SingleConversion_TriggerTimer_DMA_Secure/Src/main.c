...
/**
  ...
  *         - Group regular
  *           - Trigger source:         External trigger start: Timer 2 trigger
  ...
  *         - Channel
  *           - Sampling time:          ADCx ADCx_CHANNELa set to sampling time 160.5 ADC clock cycles (on this STM32 series, sampling time is channel wise)
