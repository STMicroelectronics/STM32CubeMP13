 ...
 */
#define IWDG_WINDOW (32000 * 400) / (16 * 1000); /* 800 => 400 ms */
#define IWDG_RELOAD (32000 * 762) / (16 * 1000); /* 1561 => 762 ms */
/* USER CODE END PD */
...
int main(void)
{
  ...
  if (__HAL_RCC_GET_FLAG(RCC_FLAG_IWDG1RST) != 0x00u)
  {
    /* IWDGRST flag set: Turn LED_BLUE on and set IwdgStatus */
    IwdgStatus = 1;
    BSP_LED_On(LED_BLUE);
    ...
    /* Prior to clear IWDGRST flag: Turn LED_BLUE off */
