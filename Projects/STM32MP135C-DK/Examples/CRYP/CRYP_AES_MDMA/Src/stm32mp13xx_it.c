...
extern MDMA_HandleTypeDef hmdmain;
extern MDMA_HandleTypeDef hmdmaout;
...
{
  /* USER CODE BEGIN HAL_IncTick 0 */

  /* USER CODE END HAL_IncTick 0 */
  HAL_IncTick();
  /* USER CODE BEGIN HAL_IncTick 1 */

  /* USER CODE END HAL_IncTick 1 */
}
