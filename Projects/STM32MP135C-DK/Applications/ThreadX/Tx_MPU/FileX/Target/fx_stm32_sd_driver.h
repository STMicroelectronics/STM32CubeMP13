...
#define FX_STM32_SD_PRE_WRITE_TRANSFER(_media_ptr)         FX_STM32_SD_PRE_READ_TRANSFER(_media_ptr)
...
#define FX_STM32_SD_POST_WRITE_TRANSFER(_media_ptr)        FX_STM32_SD_POST_READ_TRANSFER(_media_ptr)
...
#define FX_STM32_SD_WRITE_TRANSFER_ERROR(_status_)        FX_STM32_SD_READ_TRANSFER_ERROR(_status_)
