...
When an SD card is inserted into the STM32MP135F-DK SD card reader and the board is powered up, the application starts file operations.
...
In order to make the program work, you must do the following :
  ...
  - Rebuild all Fx_MultiAccess_A7 files and load your image into target memory
  - Run the application
