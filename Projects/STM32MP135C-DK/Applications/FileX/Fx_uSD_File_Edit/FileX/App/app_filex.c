...
uint32_t media_memory[FX_STM32_SD_DEFAULT_SECTOR_SIZE / sizeof(uint32_t)]  __attribute__ ((aligned(4), section(".SdBufferSection")));
...
void fx_thread_entry(ULONG thread_input)
{
  ...
  if(BSP_SD_IsDetected(FX_STM32_SD_INSTANCE) == SD_PRESENT)
  {
