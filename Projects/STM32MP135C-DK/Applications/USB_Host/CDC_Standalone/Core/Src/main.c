...
/**
  ...
  * @brief   USB Host MSC demo main file
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  COM_Init.Parity     = (COM_ParityTypeDef)UART_PARITY_NONE;
  COM_Init.StopBits   = (COM_StopBitsTypeDef)UART_STOPBITS_1;
  COM_Init.WordLength = UART_WORDLENGTH_8B;
  COM_Init.HwFlowCtl  = (COM_HwFlowCtlTypeDef)UART_HWCONTROL_NONE;
