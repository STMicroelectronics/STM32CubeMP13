...
Each time the user pushes the Tamper button of the STM32MP135F-DK board, an echo
...
@par Directory contents
  ...
  - LwIP/LwIP_TCP_Echo_Client/Core/Inc/app_ethernet.h          		header of app_ethernet.c file
  - LwIP/LwIP_TCP_Echo_Client/Core/Inc/ethernetif.h            		header for ethernetif.c file
  - LwIP/LwIP_TCP_Echo_Client/Core/Inc/stm32mp13xx_hal_conf.h    	HAL configuration file
  - LwIP/LwIP_TCP_Echo_Client/Core/Inc/stm32mp13xx_it.h          	STM32 interrupt handlers header file
  - LwIP/LwIP_TCP_Echo_Client/Core/Inc/main.h                  		Main program header file
  - LwIP/LwIP_TCP_Echo_Client/Core/Inc/lwipopts.h              		LwIP stack configuration options
  - LwIP/LwIP_TCP_Echo_Client/Core/Inc/tcp_echoclient.h                 Header for tcp echoclient application
  - LwIP/LwIP_TCP_Echo_Client/Core/Src/app_ethernet.c          		Ethernet specific module
  - LwIP/LwIP_TCP_Echo_Client/Core/Src/main.c                  		Main program
  - LwIP/LwIP_TCP_Echo_Client/Core/Src/stm32mp13xx_it.c                 Interrupt handlers
  - LwIP/LwIP_TCP_Echo_Client/Core/Src/stm32mp13xx_hal_msp.c            MSP Initialization file
  - LwIP/LwIP_TCP_Echo_Client/Core/Src/ethernetif.c            		Interfacing LwIP to ETH driver
  - LwIP/LwIP_TCP_Echo_Client/Core/Src/tcp_echoclient.c               	tcp echoclient application
...
In order to make the program work, you must do the following :
 ...
 - Rebuild all LwIP_TCP_Echo_Client application files and load your image into target memory
 - Run the application
