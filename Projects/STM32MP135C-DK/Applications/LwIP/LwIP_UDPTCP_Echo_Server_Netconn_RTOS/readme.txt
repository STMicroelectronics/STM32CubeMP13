...
@par Directory contents
  ...
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/app_ethernet.h          		header of app_ethernet.c file
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/ethernetif.h            		header for ethernetif.c file
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/stm32mp13xx_hal_conf.h    	HAL configuration file
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/stm32mp13xx_it.h          	STM32 interrupt handlers header file
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/main.h                  		Main program header file
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/lwipopts.h              		LwIP stack configuration options
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/FreeRTOSConfig.h        		FreeRTOS configuration options
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/tcpecho.h               		header for tcpecho.c
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Inc/udpecho.h               		header for udpecho.c
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/app_ethernet.c          		Ethernet specific module
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/main.c                  		Main program
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/stm32mp13xx_hal_timebase_tim.c   HAL timebase file
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/stm32mp13xx_it.c                 Interrupt handlers
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/stm32mp13xx_hal_msp.c            MSP Initialization file
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/ethernetif.c            		Interfacing LwIP to ETH driver
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/tcpecho.c               		tcp echo server main thread
  - LwIP/LwIP_UDPTCP_Echo_Server_Netconn_RTOS/Core/Src/udpecho.c               		udp echo server main thread
...
In order to make the program work, you must do the following :
 ...
 - Rebuild all LwIP_UDPTCP_Echo_Server_Netconn application files and load your image into target memory
 - Run the application
