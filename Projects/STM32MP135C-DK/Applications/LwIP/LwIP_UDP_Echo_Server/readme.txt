...
@par Directory contents
  ...
  - LwIP/LwIP_UDP_Echo_Server/Core/Inc/app_ethernet.h          		header of app_ethernet.c file
  - LwIP/LwIP_UDP_Echo_Server/Core/Inc/ethernetif.h            		header for ethernetif.c file
  - LwIP/LwIP_UDP_Echo_Server/Core/Inc/stm32mp13xx_hal_conf.h    	HAL configuration file
  - LwIP/LwIP_UDP_Echo_Server/Core/Inc/stm32mp13xx_it.h          	STM32 interrupt handlers header file
  - LwIP/LwIP_UDP_Echo_Server/Core/Inc/main.h                  		Main program header file
  - LwIP/LwIP_UDP_Echo_Server/Core/Inc/lwipopts.h              		LwIP stack configuration options
  - LwIP/LwIP_UDP_Echo_Server/Core/Inc/udp_echoserver.h                 Header for udp echo server application
  - LwIP/LwIP_UDP_Echo_Server/Core/Src/app_ethernet.c          		Ethernet specific module
  - LwIP/LwIP_UDP_Echo_Server/Core/Src/main.c                  		Main program
  - LwIP/LwIP_UDP_Echo_Server/Core/Src/stm32mp13xx_it.c                 Interrupt handlers
  - LwIP/LwIP_UDP_Echo_Server/Core/Src/stm32mp13xx_hal_msp.c            MSP Initialization file
  - LwIP/LwIP_UDP_Echo_Server/Core/Src/ethernetif.c            		Interfacing LwIP to ETH driver
  - LwIP/LwIP_UDP_Echo_Server/Core/Src/udp_echoserver.c               	udp echo server application
...
In order to make the program work, you must do the following :
 ...
 - Rebuild all LwIP_UDP_Echo_Server application files and load your image into target memory
 - Run the application
