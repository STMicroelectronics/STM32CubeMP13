...
void Ethernet_Link_Periodic_Handle2(struct netif *netif)
{
  /* Ethernet Link every 100ms */
  if (HAL_GetTick() - EthernetLinkTimer2 >= 100)
  {
    EthernetLinkTimer2 = HAL_GetTick();
    ethernet_link_check_state(netif, 2);
  }
}
#endif
