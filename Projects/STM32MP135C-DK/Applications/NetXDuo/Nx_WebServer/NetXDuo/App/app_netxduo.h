...
/* USER CODE BEGIN EFP */
extern TX_BYTE_POOL nx_app_byte_pool;
...
#define DHCP_PACKET_SIZE                 NX_DHCP_PACKET_PAYLOAD
#define DHCP_POOL_SIZE                   NX_DHCP_PACKET_POOL_SIZE

#define SD_BUFFER_SIZE                   (4*512)
