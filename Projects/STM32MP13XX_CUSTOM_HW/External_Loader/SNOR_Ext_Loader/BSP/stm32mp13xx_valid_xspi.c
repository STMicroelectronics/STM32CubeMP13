/**
  ...
  *          memory mounted on STM32MP13XX_VALID1 board.
  ******************************************************************************
  * @attention
  *
...
uint8_t XSPI_AutoPollingMemReady(void)
{
  ...
  /* IMP:This ConfigCmd is to be populated before issuing HAL_XSPI_AutoPolling() API */
  ConfigCmd = sCommand;
...
uint8_t BSP_XSPI_EnableMemoryMappedMode(void) {
  ...
  /* IMP:This ConfigCmd is to be populated before issuing HAL_XSPI_MemoryMapped() API */
  ConfigCmd = sCommand;
