...
This example provides a reference to initialize the DDR on STM32MP13XX_CUSTOM_HW
...
LEDs can be used to monitor the initialization status:
...
@par Directory contents
  ...
  - DDR_Init/Inc/stm32mp13xx_valid_conf.h  	STM32MP13XX_CUSTOM_HW board configuration file
