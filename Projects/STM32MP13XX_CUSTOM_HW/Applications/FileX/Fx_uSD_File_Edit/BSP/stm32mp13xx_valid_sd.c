/**
  ******************************************************************************
  * @file    stm32mp13xx_valid_sd.c
  * @author  MCD Application Team
  * @brief   This file includes the uSD card driver mounted on STM32MP13XX_CUSTOM_HW
  *          boards.
  @verbatim
  How To use this driver:
  -----------------------
   - This driver is used to drive the micro SD external cards mounted on STM32MP13XX_CUSTOM_HW
     board.
...
/** @defgroup STM32MP13XX_VALID_SD SD
  * @{
  */


/** @defgroup STM32MP13XX_VALID_SD_Private_TypesDefinitions Private TypesDefinitions
  * @{
  */
...
/** @defgroup STM32MP13XX_VALID_SD_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32MP13XX_VALID_SD_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32MP13XX_VALID_SD_Private_Functions_Prototypes Private Functions Prototypes
  * @{
  */
...
/** @addgroup STM32MP13XX_VALID_SD_Exported_Functions Exported Functions
  * @{
  */
...
__weak HAL_StatusTypeDef MX_SDMMC1_SD_Init(SD_HandleTypeDef *hsd)
{
  ...
  hsd->Init.BusWide             = SDMMC_BUS_WIDE_4B; //Patch SDMMC_BUS_WIDE_1B
  hsd->Init.HardwareFlowControl = SDMMC_HARDWARE_FLOW_CONTROL_DISABLE;
  hsd->Init.ClockDiv            = 32; //Patch SDMMC_NSpeed_CLK_DIV
...
//    HAL_GPIO_WritePin(SD_GPIO_PORT[Instance], PinDetect[Instance], GPIO_PIN_SET);
    ...
    else
    {
	  ...
	  #if defined (CORE_CA7)
	    IRQ_SetPriority(SD_EXTI_IRQn[Instance], BSP_SD_IT_PRIORITY);
	    IRQ_Enable(SD_EXTI_IRQn[Instance]);
	  #endif
...
/** @defgroup STM32MP13XX_VALID_SD_Private_Functions Private Functions
  * @{
  */
#if (USE_HAL_SD_REGISTER_CALLBACKS == 1)
/**
  ...
  // Reset SDMMC1 Hw IP
   ...
   GPIO_Init_Structure.Speed     = GPIO_SPEED_FREQ_HIGH;
     ...
     HAL_GPIO_Init(GPIOC, &GPIO_Init_Structure);
      ...
      #if defined (CORE_CA7)
        IRQ_SetPriority(SDMMC1_IRQn, DEFAULT_IRQ_PRIO);
