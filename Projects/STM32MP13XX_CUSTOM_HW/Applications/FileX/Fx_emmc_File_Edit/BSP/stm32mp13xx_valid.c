/**
  ...
  * @file    stm32mp13xx_valid.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to manage LEDs,
  *          push-buttons and COM ports available on STM32MP13xx validation
  *          boards (STM32MP13XX_CUSTOM_HW) from STMicroelectronics.
  *
  @verbatim
  *
  @endverbatim
...
/** @defgroup STM32MP13XX_VALID_LOW_LEVEL_Private_TypesDefinitions Private Typedef
  * @{
  */
...
/** @defgroup STM32MP13XX_VALID_LOW_LEVEL_Private_Defines Private Def
  * @{
  */

/** @brief STM32MP13XX VALID BSP Driver version number V0.0.2
  */
#define STM32MP13XX_VALID_BSP_VERSION_MAIN   (0x00U) /*!< [31:24] main version */
#define STM32MP13XX_VALID_BSP_VERSION_SUB1   (0x00U) /*!< [23:16] sub1 version */
#define STM32MP13XX_VALID_BSP_VERSION_SUB2   (0x06U) /*!< [15:8]  sub2 version */
#define STM32MP13XX_VALID_BSP_VERSION_RC     (0x00U) /*!< [7:0]  release candidate */
#define STM32MP13XX_VALID_BSP_VERSION         ((STM32MP13XX_VALID_BSP_VERSION_MAIN << 24)\
                                             |(STM32MP13XX_VALID_BSP_VERSION_SUB1 << 16)\
                                             |(STM32MP13XX_VALID_BSP_VERSION_SUB2 << 8 )\
                                             |(STM32MP13XX_VALID_BSP_VERSION_RC))
/**
  * @}
  */


/** @defgroup STM32MP13XX_VALID_LOW_LEVEL_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup STM32MP13XX_VALID_LOW_LEVEL_Private_FunctionPrototypes Private Prototypes
  * @{
  */
#ifdef HAL_EXTI_MODULE_ENABLED
...
/** @addtogroup STM32MP13XX_VALID_LOW_LEVEL_Exported_Functions Exported Functions
  * @{
  */

  /**
  * @brief  This method returns the STM32MP13XX VALID BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
uint32_t BSP_GetVersion(void)
{
  return STM32MP13XX_VALID_BSP_VERSION;
}
...
int32_t BSP_LED_On(Led_TypeDef Led)
{
  ...
  else if ((Led == LED3) || (Led == LED4))
  {
    HAL_GPIO_WritePin(LED_PORT[Led], LED_PIN[Led], GPIO_PIN_SET);
  }
#endif /* USE_STM32MP13XX_CUSTOM_HW */
  return status;
}
...
/** @addtogroup STM32MP13XX_VALID_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */

#ifdef HAL_EXTI_MODULE_ENABLED
/** @addtogroup STM32MP13XX_VALID_LOW_LEVEL_Private_Functions_Group1 BUTTON Functions
  * @{
  */
...
#if (USE_BSP_COM_FEATURE == 1)
#ifdef HAL_UART_MODULE_ENABLED
/** @addtogroup STM32MP13XX_VALID_LOW_LEVEL_Private_Functions_Group2 COM Functions
  * @{
  */
/**
