...
int main(void)
{
  ...
  /* Enable traces output from IDE console by using semihosting feature */
...
// add your config test
  ...
  printf("\n\r Hello World - STM32MP13XX_CUSTOM_HW BOARD     \n\r");
#else
  printf("\n\r Hello World - No Board Selected     \n\r");
#endif
...
void SystemClock_Config(void)
{
  ...
  RCC_OscInitStructure.PLL3.PLLR = 37;
  ...
  RCC_OscInitStructure.PLL4.PLLM = 4;
  RCC_OscInitStructure.PLL4.PLLN = 99;
  RCC_OscInitStructure.PLL4.PLLP = 6;
